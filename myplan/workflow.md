...
| 編號 | 任務項目 | 狀態 |
| :---: | :--- | :---: |
| 01-04 | CWA API 帳號註冊、Key 申請與 Requests 資料取得 | 規劃完成 |
| 05-07 | JSON 提取 MinT / MaxT 與 Pandas 整理 | 規劃完成 |
| 08-10 | SQLite `data.db` 建立、Schema 設計與防重複邏輯 | 規劃完成 |
| 11-16 | Streamlit 下拉選單、折線圖與表格整合 | 規劃完成 |
| 17-19 | Folium 台灣地圖色階可視化與日期篩選 | 規劃完成 |
| 20-21 | 程式碼異常處理、重構優化與 GitHub 上傳 | 進行中 |
| 22-24 | LINE Bot 與 AI 延伸應用實作 | 展望規劃 |
