...
首頁的「即時氣象地圖」使用中央氣象署自動氣象站資料，提供氣溫、雨量、雷達、颱風、風速風向、濕度、天氣與測站點位八種模式。另有氣象警特報、縣市界線、數字標籤、深色／街道底圖、瀏覽器定位、全螢幕與手動更新功能。測站資料快取 10 分鐘，CWA API 暫時無法連線時會使用最近一次成功快取；雷達圖資來自 RainViewer。
